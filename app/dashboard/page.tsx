      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, gap: 12, flexWrap: 'wrap' }}>
          <div style={{ flex: '1 1 auto', minWidth: 0 }}>
            <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 4, color: '#111', margin: 0 }}>Dashboard</h1>
            <p style={{ color: '#777', margin: 0, marginTop: 4, fontSize: 14 }}>Your creator program at a glance</p>
          </div>
        ...
        {loading ? (
          ...
          <div style={{ background: '#fff', borderRadius: 14, padding: 48, textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: '#111' }}>No data yet</h2>
            <p style={{ color: '#777', fontSize: 14, marginBottom: 20 }}>Save some creators to see your dashboard come to life.</p>
          ...
          <>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 10, marginBottom: 20 }}>
              <div style={{ background: '#fff', borderRadius: 14, padding: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <p style={{ margin: 0, fontSize: 12, color: '#999', marginBottom: 6 }}>Total saved</p>
                <p style={{ margin: 0, fontSize: 26, fontWeight: 700, color: '#111' }}>{total}</p>
              </div>
              <div style={{ background: '#fff', borderRadius: 14, padding: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <p style={{ margin: 0, fontSize: 12, color: '#999', marginBottom: 6 }}>Conversion rate</p>
                <p style={{ margin: 0, fontSize: 26, fontWeight: 700, color: '#2e7d32' }}>{conversionRate}%</p>
              </div>
              <div style={{ background: '#fff', borderRadius: 14, padding: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <p style={{ margin: 0, fontSize: 12, color: '#999', marginBottom: 6 }}>Total reach</p>
                <p style={{ margin: 0, fontSize: 26, fontWeight: 700, color: '#111' }}>{totalReach.toLocaleString()}</p>
              </div>
            </div>

            <div style={{ background: '#fff', borderRadius: 14, padding: 20, marginBottom: 20, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
              <h2 style={{ fontSize: 16, fontWeight: 600, marginTop: 0, marginBottom: 16, color: '#111' }}>Pipeline</h2>
              {counts.map((c) => {
            ...
            <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
              <h2 style={{ fontSize: 16, fontWeight: 600, marginTop: 0, marginBottom: 16, color: '#111' }}>Top niches</h2>
              {topNiches.map(([niche, stats]) => (
                <div key={niche} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #f5f5f5', gap: 10, flexWrap: 'wrap' }}>
